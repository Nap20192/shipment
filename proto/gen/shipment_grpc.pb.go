...
const (
	...
	ShipmentService_GetShipmentEventHistory_FullMethodName = "/shipment.v1.ShipmentService/GetShipmentEventHistory"
)
...
type ShipmentServiceClient interface {
	...
	GetShipmentEventHistory(ctx context.Context, in *GetShipmentEventHistoryRequest, opts ...grpc.CallOption) (*GetShipmentEventHistoryResponse, error)
}
...
func (c *shipmentServiceClient) GetShipmentEventHistory(ctx context.Context, in *GetShipmentEventHistoryRequest, opts ...grpc.CallOption) (*GetShipmentEventHistoryResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(GetShipmentEventHistoryResponse)
	err := c.cc.Invoke(ctx, ShipmentService_GetShipmentEventHistory_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type ShipmentServiceServer interface {
	...
	GetShipmentEventHistory(context.Context, *GetShipmentEventHistoryRequest) (*GetShipmentEventHistoryResponse, error)
...
func (UnimplementedShipmentServiceServer) GetShipmentEventHistory(context.Context, *GetShipmentEventHistoryRequest) (*GetShipmentEventHistoryResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method GetShipmentEventHistory not implemented")
}
...
func _ShipmentService_GetShipmentEventHistory_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(GetShipmentEventHistoryRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(ShipmentServiceServer).GetShipmentEventHistory(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: ShipmentService_GetShipmentEventHistory_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ShipmentServiceServer).GetShipmentEventHistory(ctx, req.(*GetShipmentEventHistoryRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var ShipmentService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "GetShipmentEventHistory",
			Handler:    _ShipmentService_GetShipmentEventHistory_Handler,
		},
	},
